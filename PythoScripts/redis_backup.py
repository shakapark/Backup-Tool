...
if __name__ == '__main__':
    ...
    parser.add_argument('-backup_dir', type=str, dest='backup_dir', help='backup directory', default='/tmp')
    parser.add_argument('-backup_filename', type=str, dest='backup_filename', help='',
                        default='redis_dump_%d-%m-%Y')
    parser.add_argument('-redis_port', type=int, dest='redis_port', help='redis port', default=6379)
    parser.add_argument('-redis_host', type=str, dest='redis_host', help='redis host', default='127.0.0.1')
    ...
    print 'connected to redis server %s:%d' % (args.redis_host,args.redis_port)
